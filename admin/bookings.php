...
if (isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO registration (roomno, feespm, foodstatus, stayfrom, duration, course, regno, firstName, middleName, lastName, gender, contactno, emailid, corresAddress, corresCity, corresPincode) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    $stmt = $mysqli->prepare($query);
    $rc = $stmt->bind_param('iiisissssssisiss', $roomno, $feespm, $foodstatus, $stayfrom, $duration, $course, $regno, $fname, $mname, $lname, $gender, $contactno, $emailid, $caddress, $ccity, $cpincode);
    $stmt->execute();
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="regno" id="regno"
                                            placeholder="Enter registration number" class="form-control" required>
                                    </div>
                                </div>
                            </div>
                        </div>
