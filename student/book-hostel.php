...
if (isset($_POST['submit'])) {
    ...
    $query = "INSERT into  registration(roomno,seater,feespm,foodstatus,stayfrom,duration,course,regno,firstName,middleName,lastName,gender,contactno,emailid,corresAddress,corresCIty,corresPincode) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
    $stmt = $mysqli->prepare($query);
    $rc = $stmt->bind_param('iiiisissssssisssi', $roomno, $seater, $feespm, $foodstatus, $stayfrom, $duration, $course, $regno, $fname, $mname, $lname, $gender, $contactno, $emailid, $caddress, $ccity, $cpincode);
    $stmt->execute();
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <input type="text" id="seater" name="seater" placeholder="Enter Seater No."
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="custom-control custom-radio">
                                        ...
                                        <label class="custom-control-label" for="customRadio1">Required
                                            <code>Extra 8000 Per Month</code></label>
                                    </div>
                                    <div class="custom-control custom-radio">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="fpm" id="fpm" placeholder="Your total fees"
                                            class="form-control">
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <input type="text" name="mname" id="mname"
                                                value="<?php echo $row->middleName; ?>" class="form-control" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <input type="number" name="contact" id="contact"
                                                value="<?php echo $row->contactNo; ?>" class="form-control" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
